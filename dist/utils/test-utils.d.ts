...
export declare const getSearchInput: () => HTMLInputElement;
export declare const getCountrySelector: () => HTMLElement;
export declare const getCountrySelectorDropdown: () => HTMLDivElement;
export declare const getCountrySelectorDropdownUl: () => HTMLUListElement;
